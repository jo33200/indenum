    ...
    <div className="max-w-lg mx-auto p-8 bg-white shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="flex items-center justify-center bg-blue-500 text-white py-2 px-6 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
