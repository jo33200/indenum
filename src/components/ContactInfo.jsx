...
const ContactInfo = ({ isFooter = false }) => (
  <div className="mx-auto flex max-w-lg flex-col gap-10 p-8">
    {!isFooter && (
    ...
    <nav className="h-full w-auto">
      <ul
        className={`flex flex-col ${isFooter ? "gap1 items-start justify-start text-left" : "items-center justify-center gap-2 text-center"} `}
      >
    ...
    <div className="flex justify-center">
      <iframe
        ...
        className={`border-0 ${isFooter ? "h-200 w-300" : "h-200 w-300 left-0 top-0 lg:h-80 lg:w-full"}`}
        allowFullScreen=""
        loading="lazy"
